...
class PyramidFeatures(nn.Module):
    ...
    def forward(self, inputs):
        ...
        P7_x = self.P7_1(P6_x)
        P7_x = self.P7_2(P7_x)
        #print('P3_x: {} , P4_x: {} , P_5_x: {} , P_6_x: {} , P_7_x: {}'.format(P3_x.size(), P4_x.size(), P5_x.size(), P6_x.size(), P7_x.size()))


       # print('P3_x; {}, P4_x: {}, P4_x: {}, P5_x: {}, P5_x: {}, P7_x: {}'.fotmat(P3_x.size(), P4_x.size(), P5_x.size(), P6_x.size(), P7_x.size()))
       # print('===++++++++++++++++++++++============')
...
def resnet50(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_loacaltion['resnet50'], map_location=None), strict=False)
